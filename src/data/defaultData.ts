...
export const defaultData: FinancialData = {
  ...
  expenseCategories: [
    { id: uid(), name: 'Home',                  budget: 2_189, color: '#7aa2f7' },
    { id: uid(), name: 'Automotive',            budget: 1_113, color: '#9ece6a' },
    { id: uid(), name: 'Food & Drink',          budget:   847, color: '#e0af68' },
    { id: uid(), name: 'Bills & Utilities',     budget:   611, color: '#f7768e' },
    { id: uid(), name: 'Groceries',             budget:   519, color: '#bb9af7' },
    { id: uid(), name: 'Health & Wellness',     budget:   517, color: '#ff9e64' },
    { id: uid(), name: 'Personal',              budget:   242, color: '#73daca' },
    { id: uid(), name: 'Entertainment',         budget:   301, color: '#2ac3de' },
    { id: uid(), name: 'Gas',                   budget:   179, color: '#a9b1d6' },
    { id: uid(), name: 'Shopping',              budget:   214, color: '#cba6f7' },
    { id: uid(), name: 'Gifts & Donations',     budget:   190, color: '#fab387' },
    { id: uid(), name: 'Travel',                budget:   195, color: '#7aa2f7' },
    { id: uid(), name: 'Education',             budget:   131, color: '#9ece6a' },
    { id: uid(), name: 'Professional Services', budget:    25, color: '#e0af68' },
    { id: uid(), name: 'Other',                 budget:     0, color: '#f7768e' },
  ],
  transactions: [],
