...
export default function App() {
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case 'fire':       return <FireTab data={finance.data} updateData={finance.updateData} totalNetWorth={finance.totalNetWorth} totalGrossIncome={finance.totalGrossIncome} totalMonthlyExpenses={finance.totalMonthlyExpenses} />;
      ...
      case 'analysis':   return <RetirementAnalysisTab data={finance.data} totalNetWorth={finance.totalNetWorth} totalContributions={finance.totalContributions} annualExpenses={finance.totalMonthlyExpenses * 12} />;
